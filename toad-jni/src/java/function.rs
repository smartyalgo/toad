  ...
  C: Class,
{
  ...
  fn find(&self, e: &mut java::Env) -> (JClass, JStaticMethodID) {
    ...
    if ids.is_none() {
      ...
      let mid = e
        .get_static_method_id(C::PATH, self.name, F::SIG)
        .unwrap_java(e);
  ...
  FR: Object,
{
  ...
  pub fn invoke(&self, e: &mut java::Env, fa: FA) -> FR {
    ...
    let (class, mid) = self.find(e);
    let jv = unsafe {
      e.call_static_method_unchecked(
        class,
        mid,
        Signature::of::<fn(FA) -> FR>().return_type(),
        &[fa.as_jni()],
  ...
  pub fn invoke(&self, e: &mut java::Env) -> Result<FR, java::lang::Throwable> {
    ...
    unsafe {
      e.call_static_method_unchecked(
        class,
        mid,
        Signature::of::<fn() -> Result<FR, java::lang::Throwable>>().return_type(),
        &[],
      )
      .to_throwable(e)
      .map(|jv| FR::upcast_value(e, jv))
  ...
  pub fn invoke(
    ...
    unsafe {
      e.call_static_method_unchecked(
        class,
        mid,
        Signature::of::<fn(FA, FB, FC, FD, FE) -> Result<FR, java::lang::Throwable>>()
          .return_type(),
        &[
          fa.as_jni(),
          fb.as_jni(),
  ...
  C: Class,
{
  ...
  pub fn invoke(&self, e: &mut java::Env) -> C {
    let jobj = e
      .new_object(C::PATH, Signature::of::<fn()>(), &[])
      .unwrap_java(e);
